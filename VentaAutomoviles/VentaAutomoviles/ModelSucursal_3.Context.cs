...
namespace VentaAutomoviles
{
    ...
    public partial class Sucursal_3Entities : DbContext
    {
        public Sucursal_3Entities()
            : base("name=Sucursal_3Entities")
        {
        }
        ...
        public virtual int spAgregarSucursal_3(Nullable<System.TimeSpan> horaEntrada, Nullable<System.TimeSpan> horaSalida, System.Data.Entity.Spatial.DbGeometry ubicacion, string pais)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spAgregarSucursal_3", horaEntradaParameter, horaSalidaParameter, ubicacionParameter, paisParameter);
        }
    }
}
